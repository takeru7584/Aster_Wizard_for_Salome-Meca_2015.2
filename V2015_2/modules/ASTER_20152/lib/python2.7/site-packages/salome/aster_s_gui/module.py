...
def run_linear_elastic_plus(mod):
    """Run wizard on linear elastic plus"""
    from aster_s_gui.wizards import linear_static_plus as LSP
    #print "Check"
    #print mod
    #print LSP
    return _run_wiz(LSP, mod)
...
#            ("linear-elastic", u"弾性応力解析", run_linear_elastic,
            ("linear-elastic", qt.QApplication.translate("WizardMenu", "Linear elastic", None, qt.QApplication.UnicodeUTF8), run_linear_elastic,
             "Wizard on linear elastic problem", "actions/run-linear-elastic.png"),
#            ("linear-elastic", "Linear elastic", run_linear_elastic,
#            ("linear-elastic-plus", u"弾性応力解析改", run_linear_elastic_plus,
            ("linear-elastic-plus", qt.QApplication.translate("WizardMenu", "Linear elastic plus", None, qt.QApplication.UnicodeUTF8), run_linear_elastic_plus,
             "Wizard on linear elastic problem plus", "actions/run-linear-elastic.png"),
#            ("modal-analysis", "Modal analysis", run_modal_analysis,
#            ("modal-analysis", u"固有値解析", run_modal_analysis,
            ("modal-analysis", qt.QApplication.translate("WizardMenu", "Modal analysis", None, qt.QApplication.UnicodeUTF8), run_modal_analysis,
             "Wizard on modal analysis problem", "actions/run-modal-analysis.png"),
#            ("linear-thermic", "Linear thermic", run_linear_thermic,
#            ("linear-thermic", u"線形熱伝導解析", run_linear_thermic,
            ("linear-thermic", qt.QApplication.translate("WizardMenu", "Linear thermic", None, qt.QApplication.UnicodeUTF8), run_linear_thermic,
             "Wizard on linear thermic problem", "actions/run-linear-thermic.png"),
#            ("Crack-analysis", "Crack analysis (X-FEM)", run_XFEM,
            ("Crack-analysis", qt.QApplication.translate("WizardMenu", "Crack analysis (X-FEM)", None, qt.QApplication.UnicodeUTF8), run_XFEM,
    ...
    def _build_main_menu(self):
        ...
        menus_desc = (
            ...
            ("Tools",
             ["run-astk", "run-eficas"]),
            ("Wizards",
             ["linear-elastic", "linear-elastic-plus", "modal-analysis", "linear-thermic", "Crack-analysis"]),
        )
